    ...
    <div class="header-top">
      <div class="container">
        ...
        <div class="header-btn-group">
          ...
          <a href=login.html class="login"><h1>LOGIN</h1></a>
    ...
    <article>
      ...
      <section class="tour-search">
        <div class="container">
          ...
          <form action="index.php" class="tour-search-form" method="post">
            ...
            <div class="input-wrapper">
              <label for="people" class="input-label">Email</label>

              <input type="number" name="email" id="people" required placeholder="Enter Your Email" class="input-field"><br>
              <label for="people" class="input-label">phone number</label>

              <input type="number" name="people" id="people" required placeholder="Enter Your Phone Number" class="input-field">
            ...
            <button type="submit" class="btn btn-secondary">Submit Your Details</button>
